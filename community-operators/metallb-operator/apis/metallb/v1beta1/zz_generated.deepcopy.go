...
func (in *AddressPoolSpec) DeepCopyInto(out *AddressPoolSpec) {
	*out = *in
	in.AddressPool.DeepCopyInto(&out.AddressPool)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AddressPoolType) DeepCopyInto(out *AddressPoolType) {
	*out = *in
	if in.Addresses != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AddressPoolType.
func (in *AddressPoolType) DeepCopy() *AddressPoolType {
	if in == nil {
		return nil
	}
	out := new(AddressPoolType)
	in.DeepCopyInto(out)
	return out
}
