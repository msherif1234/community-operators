...
import (
	...
	metallbcontroller "community-operators/community-operators/metallb-operator/controllers/metallb"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "6b654191.metallb.io",
	})
	if err != nil {
	...
	if err = (&metallbcontroller.AddressPoolReconciler{
